...
-(void)reloadData
{
    ...
    [dict setObject:@"T_MST_Warehouse" forKey:@"DataSourceCode"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  //  cell.tag=[[dic objectForKey:@"WarehouseID"] intValue];
    cell.textLabel.text=[dic objectForKey:@"WarehouseName"];
    //cell.tag=
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary *dic=_searchArr[indexPath.row];
    NSString * str=[dic objectForKey:@"WarehouseName"];
    NSString *WareID=[dic objectForKey:@"WarehouseID"];
    [_parentVC.btnKunQu setTitle:str forState:UIControlStateNormal];
    _parentVC.KuQuHiddenStr=WareID;
