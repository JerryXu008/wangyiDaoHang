...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=[dic objectForKey:@"OrganizationName"];
    //cell.tag=
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary *dic=_searchArr[indexPath.row];
    NSString * str=[dic objectForKey:@"OrganizationName"];
    NSString *WareID=[dic objectForKey:@"OrganizationCode"];
    [_parentVC.btnBuMen setTitle:str forState:UIControlStateNormal];
    _parentVC.BuMenHiddenStr=WareID;
