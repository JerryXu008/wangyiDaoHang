...
-(void)reloadData
{
    ...
    [dict setObject:@"DailyReconciliationBusinessType" forKey:@"DataSourceCode"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=[dic objectForKey:@"BusinessTypeName"];
    //cell.tag=
    // Configure the cell...
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary *dic=_searchArr[indexPath.row];
    NSString * str=[dic objectForKey:@"BusinessTypeName"];
    NSString *WareID=[dic objectForKey:@"BusinessType"];
    [_parentVC.btnYeWu setTitle:str forState:UIControlStateNormal];
    _parentVC.YeWuHiddenStr=WareID;
