...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        gTabBar = self;
        miIndex = [UserInfoManager Share].miTabIndex-1;
        self.userInteractionEnabled = YES;
        self.backgroundColor = [UIColor colorWithWhite:0.98 alpha:1.0];

        NSArray *array1 = [NSArray arrayWithObjects:@"xiaoxi2.png", @"shenpi2.png", @"kehu2", @"gengduo2",  nil];
        NSArray *array = [NSArray arrayWithObjects:@"xiaoxi1.png", @"shenpi1.png", @"kehu1", @"gengduo1",  nil];
        ...
        for (int i = 0; i<array.count; i++) {
            ...
            [button setBackgroundImage:[UIImage imageNamed:[array1 objectAtIndex:i]]  forState:UIControlStateSelected];
